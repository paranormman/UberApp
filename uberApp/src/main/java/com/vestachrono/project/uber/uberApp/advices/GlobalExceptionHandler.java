package com.vestachrono.project.uber.uberApp.advices;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiResponse<?>> handleInternalServerError(Exception exception) {
        ApiError apiError = ApiError.builder()
    ...
    ResponseEntity<ApiResponse<?>> handleInputValidationErrors(MethodArgumentNotValidException exception) {
